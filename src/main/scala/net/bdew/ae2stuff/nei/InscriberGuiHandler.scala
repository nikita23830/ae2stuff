...
object InscriberGuiHandler
    extends IContainerInputHandler
    with IContainerTooltipHandler {
  ...
  override def onMouseClicked(
      guiContainer: GuiContainer,
      i: Int,
      i1: Int,
      i2: Int
  ) = Unit
  override def onMouseScrolled(
      guiContainer: GuiContainer,
      i: Int,
      i1: Int,
      i2: Int
  ) = Unit
  override def mouseScrolled(
      guiContainer: GuiContainer,
      i: Int,
      i1: Int,
      i2: Int
  ...
  override def onMouseUp(guiContainer: GuiContainer, i: Int, i1: Int, i2: Int) =
    Unit
  ...
  override def handleTooltip(
    ...
    if (
      guiContainer.isInstanceOf[GuiInscriber] && recipesRect.contains(
        Point(x - guiContainer.guiLeft, y - guiContainer.guiTop)
      )
    )
